...
from app.services.daily_feelings.daily_feelings_route import router as daily_feelings_router
...
app.include_router(daily_feelings_router)
app.include_router(direction_matrix_router)
